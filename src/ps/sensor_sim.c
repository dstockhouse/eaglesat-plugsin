 ...
 * 	pixel sensor through the Xillybus interface to PL. This file is for the
 * 	simulations on the zynq where the vanilla Xillybus is used rather than
 * 	our own custom solution, so certain changes have to be made from the
 * 	original design.
 *
 * Author:
